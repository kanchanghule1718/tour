...
export default function CardDetails() {
    ...
    let { data: product } = useFetch(`http://localhost:3000/pets/${param.id}`)
                        ...
                        <div className="col">
                            ...
                            <div className="col" style={{ flexDirection: "column" }}>
                                <div className="row row-cols-1 row-cols-sm-2 row-cols-md-6 ">
                                    <div className="col"><img src="https://www.svgrepo.com/show/264392/meal.svg" height={50} width={50} alt='' /><span><p>Meals</p></span> </div>
                                    <div className="col"><img src="https://cdn-icons-png.freepik.com/512/1668/1668966.png" height={50} width={50} alt='' /><span><p>Hotel</p></span> </div>
                                    <div className="col"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYWVpTEEQCxkkifs0qPyzgAqzdF8RJgkDL7A&usqp=CAU" alt='' height={50} width={50} /><span><p>Transport</p></span> </div>
                                    <div className="col"><img src="https://cdn-icons-png.freepik.com/512/7060/7060076.png" height={50} width={50} alt='' /><span><p>Sightseeing</p></span> </div>
                                    <div className="col"><img src="https://cdn.iconscout.com/icon/free/png-256/free-plane-3802463-3168528.png?f=webp" alt='' height={50} width={50} /><span><p>Flights</p></span> </div>
